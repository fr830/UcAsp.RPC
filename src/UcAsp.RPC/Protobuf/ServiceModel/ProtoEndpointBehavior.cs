...
namespace UcAsp.RPC.ProtoBuf.ServiceModel
{
    /// <summary>
    ...
    ///  <behaviors>
    ///    <endpointBehaviors>
    ///      <behavior name="UcAsp.RPC.ProtoBufBehaviorConfig">
    ///        <UcAsp.RPC.ProtoBufSerialization/>
    ///      </behavior>
    ///    </endpointBehaviors>
    ///  </behaviors>
    ///  <extensions>
    ///    <behaviorExtensions>
    ///      <add name="UcAsp.RPC.ProtoBufSerialization" type="UcAsp.RPC.ProtoBuf.ServiceModel.ProtoBehaviorExtension, UcAsp.RPC.ProtoBuf-net, Version=1.0.0.255, Culture=neutral, PublicKeyToken=257b51d87d2e4d67"/>
    ///    </behaviorExtensions>
    ///  </extensions>
    /// 
    ...
    ///    <endpoint address="http://myhost:9003/SampleService" binding="basicHttpBinding" behaviorConfiguration="UcAsp.RPC.ProtoBufBehaviorConfig"
    ///     bindingConfiguration="basicHttpBindingConfig" name="basicHttpUcAsp.RPC.ProtoBuf" contract="ISampleServiceContract" />
    ///  </service>
    ///  <client>
    ...
    ///          name="BasicHttpUcAsp.RPC.ProtoBufEndpoint" behaviorConfiguration="UcAsp.RPC.ProtoBufBehaviorConfig"/>
    ///   </client>
    /// </example>
    /// </summary>
