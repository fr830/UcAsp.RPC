...
{
    /// <summary>
    /// Describes a WCF operation behaviour that can perform UcAsp.RPC.ProtoBuf serialization
    /// </summary>
    public sealed class ProtoOperationBehavior : DataContractSerializerOperationBehavior
    {
        ...
        /// <summary>
        /// Creates a UcAsp.RPC.ProtoBuf serializer if possible (falling back to the default WCF serializer)
        /// </summary>
