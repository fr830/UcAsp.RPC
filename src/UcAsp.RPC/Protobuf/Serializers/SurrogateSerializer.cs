...
namespace UcAsp.RPC.ProtoBuf.Serializers
{
    ...
    {
        bool IProtoTypeSerializer.HasCallbacks(UcAsp.RPC.ProtoBuf.Meta.TypeModel.CallbackType callbackType) { return false; }

        void IProtoTypeSerializer.EmitCallback(Compiler.CompilerContext ctx, Compiler.Local valueFrom, UcAsp.RPC.ProtoBuf.Meta.TypeModel.CallbackType callbackType) { }
        ...
        void IProtoTypeSerializer.Callback(object value, UcAsp.RPC.ProtoBuf.Meta.TypeModel.CallbackType callbackType, SerializationContext context) { }
#endif
