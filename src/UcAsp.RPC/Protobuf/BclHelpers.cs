...
namespace UcAsp.RPC.ProtoBuf
{
    ...
    /// in UcAsp.RPC.ProtoBuf, using the definitions from bcl.proto
    /// </summary>
    public
#if FX11
    sealed
        ...
        class BclHelpers
    {
        ...
        /// <summary>
        /// The default value for dates that are following google.UcAsp.RPC.ProtoBuf.Timestamp semantics
        /// </summary>
        private static readonly DateTime TimestampEpoch = EpochOrigin[(int)DateTimeKind.Utc];


        /// <summary>
        /// Writes a TimeSpan to a UcAsp.RPC.ProtoBuf stream using UcAsp.RPC.ProtoBuf-net's own representation, bcl.TimeSpan
        /// </summary>
        ...
        /// <summary>
        /// Parses a TimeSpan from a UcAsp.RPC.ProtoBuf stream using UcAsp.RPC.ProtoBuf-net's own representation, bcl.TimeSpan
        /// </summary>        
        ...
        /// <summary>
        /// Parses a TimeSpan from a UcAsp.RPC.ProtoBuf stream using the standardized format, google.UcAsp.RPC.ProtoBuf.Duration
        /// </summary>
        ...
        /// <summary>
        /// Writes a TimeSpan to a UcAsp.RPC.ProtoBuf stream using the standardized format, google.UcAsp.RPC.ProtoBuf.Duration
        /// </summary>
        ...
        /// <summary>
        /// Parses a DateTime from a UcAsp.RPC.ProtoBuf stream using the standardized format, google.UcAsp.RPC.ProtoBuf.Timestamp
        /// </summary>
        ...
        /// <summary>
        /// Writes a DateTime to a UcAsp.RPC.ProtoBuf stream using the standardized format, google.UcAsp.RPC.ProtoBuf.Timestamp
        /// </summary>
        ...
        /// <summary>
        /// Parses a DateTime from a UcAsp.RPC.ProtoBuf stream
        /// </summary>
        ...
        /// <summary>
        /// Writes a DateTime to a UcAsp.RPC.ProtoBuf stream, excluding the <c>Kind</c>
        /// </summary>
        ...
        /// <summary>
        /// Writes a DateTime to a UcAsp.RPC.ProtoBuf stream, including the <c>Kind</c>
        /// </summary>
        ...
        /// <summary>
        /// Parses a decimal from a UcAsp.RPC.ProtoBuf stream
        /// </summary>
        ...
        /// <summary>
        /// Writes a Guid to a UcAsp.RPC.ProtoBuf stream
        /// </summary>        
        ...
        /// <summary>
        /// Parses a Guid from a UcAsp.RPC.ProtoBuf stream
        /// </summary>
