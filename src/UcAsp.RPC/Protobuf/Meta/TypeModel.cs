...
{
    /// <summary>
    /// Provides UcAsp.RPC.ProtoBuf serialization support for a number of types
    /// </summary>
            ...
            if (type != null)
            {
                    ...
                    .IsGenericType && baseType.GetGenericTypeDefinition().Name == "GeneratedMessage`2")
                {
                    throw new InvalidOperationException(
                        "Are you mixing UcAsp.RPC.ProtoBuf-net and UcAsp.RPC.ProtoBuf-csharp-port? See http://stackoverflow.com/q/11564914; type: " + fullName);
                }
            }
#endif
