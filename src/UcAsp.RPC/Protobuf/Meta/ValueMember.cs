...
{
    /// <summary>
    /// Represents a member (property/field) that is mapped to a UcAsp.RPC.ProtoBuf field
    /// </summary>
    public class ValueMember
    {
        private readonly int fieldNumber;
        /// <summary>
        /// The number that identifies this member in a UcAsp.RPC.ProtoBuf stream
        /// </summary>
...
//#endif
        ...
        /// <summary>
        /// Indicates that the member should be treated as a UcAsp.RPC.ProtoBuf Map
        /// </summary>
        public bool IsMap
        {
