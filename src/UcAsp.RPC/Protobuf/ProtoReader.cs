...
{
    /// <summary>
    /// A stateful reader, used to read a UcAsp.RPC.ProtoBuf stream. Typical usage would be (sequentially) to call
 ...
 double ReadDouble()
        ...
        public int ReadFieldHeader()
        {
            ...
            if (wireType == UcAsp.RPC.ProtoBuf.WireType.EndGroup)
            {
            ...
            switch (wireType)
            {
                ...
                case WireType.StartGroup:
                    ...
                    { // we expect to exit in a similar state to how we entered
                        wireType = UcAsp.RPC.ProtoBuf.WireType.None;
                        return;
                    }
                    throw CreateWireTypeException();
 ...
 float ReadSingle()
        ...
        /// </summary>
        public static bool HasSubValue(UcAsp.RPC.ProtoBuf.WireType wireType, ProtoReader source)
        {
            if (source == null) throw new ArgumentNullException("source");
            // check for virtual end of stream
