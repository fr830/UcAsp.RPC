...
namespace UcAsp.WebSocket.Net
{
    ...
    {
        #region 私有字段
        private readonly ILog _logger = LogManager.GetLogger(typeof(HttpListener));
        ...
        /// </summary>
        /// <value>
        /// One of the <see cref="UcAsp.WebSocket.Net.AuthenticationSchemes"/> enum values,
        /// represents the scheme used to authenticate the clients. The default value is
        /// <see cref="UcAsp.WebSocket.Net.AuthenticationSchemes.Anonymous"/>.
        /// </value>
