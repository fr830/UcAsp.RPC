...
namespace UcAsp.WebSocket.Server
{
    ...
    public class WebServer
    {
        ...
        /// <paramref name="port"/> is less than 1 or greater than 65535.
        /// </exception>
        public WebServer(int port, bool secure)
        {
        ...
        /// <paramref name="port"/> is less than 1 or greater than 65535.
        /// </exception>
        public WebServer(System.Net.IPAddress address, int port)
        ...
        /// <paramref name="port"/> is less than 1 or greater than 65535.
        /// </exception>
        public WebServer(System.Net.IPAddress address, int port, bool secure)
        {
            if (address == null)
      ...
      where TBehavior : WebSocketBehavior
        ...
        ///   </para>
        /// </exception>
        public void AddWebSocketService<TBehaviorWithNew>(string path, dynamic rule)
