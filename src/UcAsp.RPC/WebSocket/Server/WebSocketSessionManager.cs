...
namespace UcAsp.WebSocket.Server
{
    ...
    public class WebSocketSessionManager
    {
            ...
            foreach (var session in Sessions)
            {
                ...
                catch (Exception ex) { }
                {
                    try
                    {
                        ...
                        ret.Add(session.ID, session.LastTime > DateTime.Now.AddMinutes(wait));
                    }
                    catch (Exception ex)
                    { }
                }
        ...
        public void Sweep()
        {
            //  Console.WriteLine("Session:" + _state + "," + _sweeping + "," + _sessions.Count);
            ...
            {
                _sweeping = true;
                // Console.WriteLine("SessionInactiveIDs:" + WaitTime + "," + InactiveIDs.ToList().Count);
                foreach (var id in InactiveIDs)
                {
                    ...
                    lock (_sync)
                    {
                        //  Console.WriteLine("Session:" + _sessions.Count);
                        IWebSocketSession session;
