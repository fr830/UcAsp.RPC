...
namespace UcAsp.WebSocket.Server
{
    ...
    public class WebSocketServiceManager
    {
        ...
        internal WebSocketServiceManager(Logger log)
        {
            ...
            _sync = ((ICollection)_hosts.Values).SyncRoot;
        ...
        ///   </para>
        /// </exception>
        public void AddService<TBehavior>(string path, Action<TBehavior> initializer, dynamic rule) where TBehavior : WebSocketBehavior, new()
        {
            if (path == null)
                throw new ArgumentNullException("path");
